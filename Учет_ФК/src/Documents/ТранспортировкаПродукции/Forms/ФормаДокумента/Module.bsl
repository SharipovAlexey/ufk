...
&НаСервере
Процедура ПродукцияВесБруттоВлажныйПриИзмененииНаСервере()
...
&НаКлиенте
Процедура ПродукцияВесБруттоВлажныйПриИзменении(Элемент)
	ПродукцияВесБруттоВлажныйПриИзмененииНаСервере();
КонецПроцедуры
