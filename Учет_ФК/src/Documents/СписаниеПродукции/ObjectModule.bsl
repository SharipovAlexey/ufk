...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Запрос.Текст = 
		...
		|					(ВЫБРАТЬ РАЗЛИЧНЫЕ
		|						СписаниеПродукции.ТранспортировочноеМесто КАК ТранспортировочноеМесто
		|					ИЗ
		|						Документ.СписаниеПродукции.Продукция КАК СписаниеПродукции
		|					ГДЕ
		|						СписаниеПродукции.Ссылка = &СсылкаНаДокумент)
		...
		|			(ВЫБРАТЬ РАЗЛИЧНЫЕ
		|				ВнутреннееПеремещениеПродукцииПродукция.ТранспортировочноеМесто КАК ТранспортировочноеМесто
		|			ИЗ
		|				Документ.СписаниеПродукции.Продукция КАК ВнутреннееПеремещениеПродукцииПродукция
		|			ГДЕ
		|				ВнутреннееПеремещениеПродукцииПродукция.Ссылка = &СсылкаНаДокумент)
		|
		|СГРУППИРОВАТЬ ПО
