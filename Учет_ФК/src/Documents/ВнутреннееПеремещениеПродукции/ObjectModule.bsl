...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Запрос.Текст = 
		...
		|					ИЗ
		|						Документ.ВнутреннееПеремещениеПродукции.Продукция КАК ВнутреннееПеремещениеПродукцииПродукция
		|					ГДЕ
		|						ВнутреннееПеремещениеПродукцииПродукция.Ссылка = &СсылкаНаДокументПеремещение)
