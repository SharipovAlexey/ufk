...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	СписокОбъектов.Добавить(Документы.ПаспортКачестваНаПартиюПродукции);
	СписокОбъектов.Добавить(Документы.ТранспортировкаПродукции);
	СписокОбъектов.Добавить(Документы.ВнутреннееПеремещениеПродукции);
	СписокОбъектов.Добавить(Документы.АктПриемаПродукцииЗаПериод);
	СписокОбъектов.Добавить(Документы.ФормированиеПартийПродукцииДляПереработки);
	СписокОбъектов.Добавить(Документы.ПаспортЛота);
	СписокОбъектов.Добавить(Документы.ПаспортПартииРеализации);
КонецПроцедуры
