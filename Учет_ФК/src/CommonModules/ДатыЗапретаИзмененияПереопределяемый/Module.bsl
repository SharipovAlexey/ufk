...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВыпускПродукции"  						, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПроведениеЛабораторныхИсследований"  	, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПаспортКачестваНаПартиюПродукции"  		, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВнутреннееПеремещениеПродукции"  		, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ТранспортировкаПродукции"  				, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПоступлениеПродукцииИзТранспортировки"  	, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.КорректировкаДвиженийРегистров"  		, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.АктПриемаПродукцииЗаПериод"  			, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ФормированиеПартийПродукцииДляПереработки" 			, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СписаниеПродукции" 						, "Дата" , , );
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПередачаПродукцииВПереработку" 			, "Дата" , , );
