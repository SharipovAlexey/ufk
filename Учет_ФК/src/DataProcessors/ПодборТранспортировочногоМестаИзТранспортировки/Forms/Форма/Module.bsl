...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокСвойств = "ДатаРасчетов, Заголовок, ИмяТаблицы, ДокументТранспортировки";
	...
	Настройки = ОбщегоНазначенияВызовСервера.ХранилищеОбщихНастроекЗагрузить("ПодборТранспортировочныхМестИзТранспортировки",);
...
Процедура УправлениеСписком()
	...
	СписокТранспортировочныхМест.Параметры.УстановитьЗначениеПараметра("ДокументОтгрузки",              ДокументТранспортировки);
